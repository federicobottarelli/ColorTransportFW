...
with st.sidebar:
    ...
    n_clusters = st.slider("Select the number of color centroids", 1, 32, value=16, step=1)
    num_epochs = st.number_input('Set the number of epochs', 10, int(1e7), value=10000, step=100)
...
st.write(
    """ ## Transfer your image
    You can play with the hyperparameters in the left column and upload your reference and input images to make your personal color transfer, hyperparameters are explained in the specific section on the right column"""
)
